...
def main(context):
    ...
    #model = models.__dict__[args.arch](encoder = args.encoder, n_classes = args.num_classes)
    ...
    if args.evaluate:
        ...
        loss = validate(eval_loader, model, validation_log, global_step, args.start_epoch, save_pred=True, mask_path=mask_path)
...
def dice_loss(pred, target):
    ...
    #LOG.info('iflat', iflat)
    #LOG.info('tflat', tflat)
    ...
    #LOG.info('A_sum', A_sum)
    #LOG.info('B_sum', B_sum)
    #LOG.info('dice', dice)
